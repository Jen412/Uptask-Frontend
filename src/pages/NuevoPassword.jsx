...
const NuevoPassword = () => {
    ...
    return (
        <>
            <h1 className="text-sky-600 font-black text-6xl capitalize">Reestablece tu password y no pierdas accceso a tus {' '}<span className="text-slate-700">proyectos</span></h1>
            ...
            {tokenValido && (
                ...
                <div className="my-5">
                    <label className="text-gray-600 uppercase block text-xl font-bold" htmlFor="password">Nuevo Password</label>
                    <input 
                        type="password" 
                        id="password"
